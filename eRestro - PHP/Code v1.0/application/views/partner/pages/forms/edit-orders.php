                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="h5">Partner Name: <span class="text text-info"><?= output_escaping($restro_name[0]['partner_name']); ?> </span></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                                    ...
                                                    <div class="media-body my-auto text-right">
                                                        <div class="row my-auto flex-column flex-md-row">
                                                            <div class="col my-auto">
                                                                ...
                                                                <?php } ?>
                                                                <?php if (isset($item['add_ons']) && !empty($item['add_ons']) && $item['add_ons'] != "" && $item['add_ons'] != "[]") { ?>
                                                                    <h6 class="mb-0 text-left"><small><a href='javascript:void(0)' data-toggle='modal' id="view_add_on" data-target='#add-ons-model' class='btn btn-info btn-xs mr-1 mb-1' title='View Add Ons'>Add Ons</a></small></h6>
                                                                <?php } ?>
                                                            </div>
                                                            <div class="col-auto my-auto">
                                                                <div class="price mb-2 list-view-price">
                                                                    ...
                                                                    <?php } ?>
                                                                    <a href=" <?= BASE_URL('partner/product/view-product?edit_id=' . $item['product_id'] . '') ?>" title="View Product" class="btn btn-info btn-xs">
                                                                        <i class="fa fa-eye"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="card card-widget widget-user-2">
                                                <div class="widget-user-header bg-info">
                                                    ...
                                                    <?php if (get_partner_permission($partner_id, 'customer_privacy')) { ?>
                                                        <h6 class="widget-user-desc"><?= $order_detls[0]['address']; ?></h6>
                                                    <?php } else { ?>
                                                        <h6 class="widget-user-desc"><?= "NO permission to view Customer details"; ?></h6>
                                                    <?php } ?>
                                                </div>
                                                <div class="card-footer p-0">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">Contact <span class="float-right text-info"><?= ((defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) || (get_partner_permission($partner_id, 'customer_privacy') == FALSE)) ? str_repeat("X", strlen($order_detls[0]['mobile']) - 3) . substr($order_detls[0]['mobile'], -3) : $order_detls[0]['mobile']; ?></span></a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">Email <span class="float-right text-info"><?= ((defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) || (get_partner_permission($partner_id, 'customer_privacy') == FALSE)) ? str_repeat("X", strlen($order_detls[0]['email']) - 3) . substr($order_detls[0]['email'], -3) : $order_detls[0]['email']; ?></span></a>
                                                        </li>
                                                        <li class="nav-item">
                                                        ...
                                                        <?php if (get_partner_permission($partner_id, 'view_order_otp')) { ?>
                                                            <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        <tbody>
                                            <?php if (get_partner_permission($partner_id, 'assign_rider')) { ?>
                                                <tr>
