<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4>Add Tags on Your partner</h4>
        </div>
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
            <!-- form start -->
            <form class="form-horizontal form-submit-event" action="<?= base_url('partner/tag/add_tags'); ?>" method="POST" enctype="multipart/form-data">
              <div class="card-body">
