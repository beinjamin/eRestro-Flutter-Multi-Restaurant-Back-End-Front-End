        ...
        <div class="col-md-12 main-content">
          <div class="card content-area p-4">
            <div class="card-innr">
              ...
              <input type="hidden" name="restro_id" value="<?= $partner_id ?>">
              <table class='table-striped' data-toggle="table" data-url="<?= base_url('partner/transaction/view_transactions?user_id='.$partner_id) ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-query-params="partner_wallet_query_params">
                <thead>
                  <tr>
