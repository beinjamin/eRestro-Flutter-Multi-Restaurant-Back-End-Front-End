                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/attribute/' ?>" class="btn btn-block btn-outline-info btn-sm">Manage</a>
                            </div>
                        </div>
                        <div class="card-innr">
                            <div class="card-head">
