                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="h6">Partner Address: <span class="text text-info"><?= $restro_name[0]['address']; ?> </span></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                            ...
                                            <div class="card card-widget widget-user-2">
                                                ...
                                                <div class="card-footer p-0">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">Email <span class="float-right text-info"><?= (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($order_detls[0]['email']) - 3) . substr($order_detls[0]['email'], -3) : $order_detls[0]['email']; ?></span></a>
                                                        </li>
                                                        <li class="nav-item">
                                                        ...
                                                        <li class="nav-item">
                                                            <?php $city = fetch_details(['id' => $order_detls[0]['city_id']], "cities", "name"); ?>
                                                    ...
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link bg-info">
                                                                Payable Total(<?= $settings['currency'] ?>) <span class="float-right"><?= number_format($total); ?></span>
                                                            </a>
                                                        </li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr><small class="text text-info">Rider will list according to Rider Serviceable City. That you can see at Rider's page. </small></tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th class="col-1">Status <span class='text-danger text-sm'>*</span></th>
                                                <td>
