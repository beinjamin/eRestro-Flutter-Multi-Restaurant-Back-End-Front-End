                                                ...
                                                <div class="col-sm-12">
                                                    <select class='form-control' name='pro_input_tax' id="pro_input_tax">
                                                        ...
                                                        <?php foreach ($taxes as $row) { ?>
                                                            <option value="<?= $row['id'] ?>" <?= (isset($product_details[0]['tax']) && $product_details[0]['tax'] == $row['id']) ? 'selected' : "" ?>><?= $row['title'] . " (" . $row['percentage'] . "%)" ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        <?php } else { ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class='form-control' name='pro_input_tax' id="pro_input_tax">
                                                        <?php if (empty($taxes)) { ?>
                                                            <option value="0" selected> No Taxes Were Added or not set default taxation </option>
                                                        <?php } ?>
                                                        <?php foreach ($taxes as $row) { ?>
                                                            <option value="<?= $row['id'] ?>" <?= (isset($default_tax_id) && !empty($default_tax_id)) ? 'selected' : "" ?>><?= $row['title'] . " (" . $row['percentage'] . "%)"  ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
