...
$config['base_url'] = 'http://localhost/erestro/';
...
$config['csrf_exclude_uris'] = array('admin/product/process_bulk_upload','admin/product/get_subcategory', 'cart/pre-payment-setup', 'cart/validate-promo-code', 'my-account/get-address', 'cart/place-order','payment/[a-z_-]+', 'admin/category/add_category', 'admin/orders/update_orders', 'admin/product/update_product_order', 'admin/orders/delete_orders', 'admin/product/delete_product', 'app/v1/api/[a-z_-]+', 'rider/app/v1/api/[a-z_-]+', 'admin/app/v1/api/[a-z_-]+', 'admin/home/fetch_sales', 'partner/app/v1/api/[a-z_-]+');
