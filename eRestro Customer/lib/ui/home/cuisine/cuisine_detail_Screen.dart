...
import 'package:erestro/features/home/cuisine/cubit/cuisineDetailCubit.dart';
      ...
      child: _connectionStatus == 'ConnectivityResult.none'
          ...
          : Scaffold(
              ...
              appBar: AppBar(
                ...
                /*bottom: PreferredSize(preferredSize: Size(width!, height!/12.0*/ /*height!/5.0*/ /*),
            child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                    ...
                    */ /*Padding(
                      ...
                      child: Text(cuisineLength.toString() + " " + StringsRes.cuisineNearby, textAlign: TextAlign.center, style: const TextStyle(color: ColorsRes.lightFont, fontSize: 12)),
                    )*/ /*
              ],
            ),
          ),*/
              ...
              body: Container(
                ...
                width: width,
                child: RefreshIndicator(onRefresh: refreshList, color: ColorsRes.red, child: cuisineDetail()),
              ),
            ),
    );
  }
