                   ...
                   child: Column(
                     ...
                     children: [
                       Padding(
                         ...
                         child: Row(
                           children: [
                             Container(width: width!/1.5, height: 8.0, color: ColorsRes.white,),
                             SizedBox(width: width! / 50.0),
                             Container(width: 15, height: 15, color: ColorsRes.white),
                           ],
                         ),
                       ),
                       Padding(
                         padding: EdgeInsets.only(
                           left: width! / 40.0, right: width! / 40.0,),
                         child: Container(width: width!/1.5, height: 8.0, color: ColorsRes.white,),
                       ),
                       Padding(
                         padding: EdgeInsets.only(
                             ...
                             itemBuilder: (BuildContext context, i) {
                               return Container(
                                   ...
                                   margin: EdgeInsets.only(
                                     left: width! / 60.0,
                                     right: width! / 60.0), width: width!/4.0, height: height!/12.0, color: ColorsRes.white,);
                             }
                           ),
                       ), Padding(
                         ...
                         child: ListView.builder(shrinkWrap: true,
                             ...
                             itemBuilder: (BuildContext context, i) {
                               return Container(
                                 ...
                                 margin: EdgeInsets.only(
                                     left: width! / 60.0,
                                     right: width! / 60.0), width: width!/6.0, height: height!/12.0, color: ColorsRes.white,);
                             }
                         ),
                       ),
                       Padding(
                       ...
                       Container(margin: EdgeInsets.only(left: width!/40.0, right: width!/40.0,),
                         padding: EdgeInsets.only(left: width!/20.0, bottom: height!/99.0),width: width!/4.0, height: height!/10.0, color: ColorsRes.white,),
                       Container(margin: EdgeInsets.only(left: width!/40.0, right: width!/40.0,),
                       ...
                       Padding(
                           padding: const EdgeInsets.only(
                               top: 4.5, bottom: 4.5),
                           child: Container(width: width!/3.0, height: height!/20.0, color: ColorsRes.white,)
                       ),
                       Padding(
                         padding: EdgeInsets.only(
                           left: width! / 40.0, right: width! / 40.0,),
                       ...
                       Padding(
                           padding: const EdgeInsets.only(
                               top: 4.5, bottom: 4.5),
                           child: Container(width: width!/4.0, height: height!/20.0, color: ColorsRes.white,)
                       ),
                       Padding(
                         padding: EdgeInsets.only(
                           left: width! / 40.0, right: width! / 40.0,),
