...
class OrderDeliveredScreen extends StatefulWidget {
  ...
  @override
  OrderDeliveredScreenState createState() => OrderDeliveredScreenState();
...
class OrderDeliveredScreenState extends State<OrderDeliveredScreen> {
  double? width, height;
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              return Container(
                                  ...
                                  //height: height!/4.7,
                                  width: width!,
                                  margin: EdgeInsets.only(left: width! / 40.0, right: width! / 60.0, bottom: height! / 99.0, top: height! / 99.0),
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Text(orderList[index].orderItems![i].name! + " x " + orderList[index].orderItems![i].quantity!,
                                        textAlign: TextAlign.center,
                                    ...
                                    orderList[index].orderItems![i].attrName != ""
                                        ? Row(
                                            ...
                                            children: [
                                              Text(orderList[index].orderItems![i].attrName! + " : ",
                                                  ...
                                                  style: const TextStyle(color: ColorsRes.lightFont, fontSize: 12, fontWeight: FontWeight.w500)),
                                        ...
                                        : Container(),
                                    const SizedBox(height: 5.0),
                                    Text(context.read<SystemConfigCubit>().getCurrency() + " " + orderList[index].orderItems![i].price!,
                                        textAlign: TextAlign.center,
      ...
      child: _connectionStatus == 'ConnectivityResult.none'
          ...
          : Scaffold(
              ...
              appBar: AppBar(
                ...
                elevation: 0,
                centerTitle: true,
                title: Text(StringsRes.orderDelivered,
